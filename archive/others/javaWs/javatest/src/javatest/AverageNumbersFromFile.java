 ...
 * of the numbers that it reads. The file should contain nothing but numbers of
 * type double; if this is not the case, the output will be the sum and average
 * of however many numbers were successfully read from the file. The name of the
