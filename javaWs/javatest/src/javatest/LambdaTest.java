 ...
 * function that can create ArrayProcessors for counting occurrences of values
 * in an array. (Note that this program depends on interface ArrayProcessor.)
 */
public class LambdaTest {

	/**
	 * This function returns an ArrayProcessor that counts the number of times a
	 * certain value occurs in an array of doubles. The parameter specifies the
	 * value that is to be counted.
	 */
	...
	/**
	 * An ArrayProcessor that computes and returns the maximum value of an array.
	 * (The array must have length at least 1.)
	 */
	...
	/**
	 * An ArrayProcessor that computes and returns the minimum value of an array.
	 * (The array must have length at least 1.)
	 */
	...
	/**
	 * An ArrayProcessor that computes and returns the sum of the values in an
	...
	/**
	 * An ArrayProcessor that computes and returns the average of the values in an
	 * array. (The array must have length at least 1.)
	 */
